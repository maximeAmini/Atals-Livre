    ...
    <section class="container-fluid col-lg-10 offset-lg-2 col-md-9 offset-md-3" id='princi'>
        ...
        <article>
            ...
            <div class="table-responsive">
                <form method="post" action="ajouterLivrePromo_controleur.php?promo=<?php echo $_GET['promo']; ?>">
                        ...
                        <tr>
                            ...
                            <td style="width:25%;">
                                ...
                                <span style="font-size:13px; ">
                                    <a href="ajouterLivrePromo_controleur.php?promo=<?php echo $_GET['promo']; ?>&add=<?php echo $livre['id']; ?>" style="color:#28a745;">Ajouter</a>
                                </span>
                            </td>
