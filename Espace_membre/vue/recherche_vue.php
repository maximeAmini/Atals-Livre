    ...
    <section class="container" id="princi">
        <article>
            ...
            <article>
                ...
                <div class="row">
                    <form class="form-inline col-sm-12" style="padding-top:10px;" method="get"
                        action="recherche_controleur.php">
                        <div class="input-group col-sm-8 offset-sm-2">
                            <input type="search" class="form-control col-sm-12" placeholder="Recherche" name="rech"
                                style="background-color:#fff;">
                            <div class="input-group-prepend">
                                <button type="submit" class="input-group-text rounded-right"
                                    style="background-color:#fff;"><i class="fas fa-search"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
